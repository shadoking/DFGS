ckpt=/home/drip00/drip/private/rrq/DynamiCrafter/checkpoints/dynamicrafter_512_interp_v1/model.ckpt
...
CUDA_VISIBLE_DEVICES=0 HF_ENDPOINT=https://hf-mirror.com python3 scripts/evaluation/inference.py \
--seed ${seed} \
--ckpt_path $ckpt \
--config $config \
